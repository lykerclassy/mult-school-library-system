...
import {
  ...
  Megaphone, LifeBuoy, SlidersHorizontal, Calendar, Globe, ShieldCheck,
} from 'lucide-react';
...
const Sidebar = () => {
  ...
  const navLinks = {
    Developer: [
      ...
      { name: 'Global Users', icon: Users, path: '/dev/users' },
      { name: 'Global Resources', icon: Globe, path: '/dev/resources' },
      ...
      { name: 'Activity Log', icon: ShieldCheck, path: '/dev/logs' },
    ...
    SchoolAdmin: [
      ...
      { name: 'Subscription', icon: CreditCard, path: '/subscription' }, // <-- ADDED
